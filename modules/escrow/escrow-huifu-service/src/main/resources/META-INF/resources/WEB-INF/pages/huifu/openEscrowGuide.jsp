...
<%@page import="com.dimeng.p2p.escrow.huifu.entity.register.OpenEscrowGuideEntity"%>
    ...
    <div class="user_wrap w1002 clearfix">
        ...
        <div class="r_main">
            <div class="user_mod border_t15">
                <div class="user_til"><i class="icon"></i><span class="gray3 f18">开通托管账户</span></div>
                <div class="topup_problem mt20"><i class="problem_icon"></i>请您认真填写以下信息，确保您开户成功</div>
                <form target="_bank" action="<%=configureProvider.format(URLVariable.ESCROW_URL_USERREGISTER)%>" method="post" onsubmit="return onSubmit();">
	                    ...
	                    <ul class="cell">
	                        ...
	                        <li>
	                            ...
	                            <div class="info">
                            		...
                            		<input name="input" id="btnVerifyCode" type="button" onclick="bandPhone(this)" value="获取验证码" class="btn05"/>
                            		<p tip></p>
                        			<p errortip class="" style="display: none"></p>
	                            </div>
	                            <div class="clear"></div>
	                ...
	                <div class="tc mt30">
	                	<input type="submit" id="openSumbit" style="cursor: pointer;" value="立即开通"
...
<script type="text/javascript" src="<%=controller.getStaticPath(request)%>/js/huifu/openEscrowGuide.js"></script>
...
<script type="text/javascript">
	<%--获取手机验证码URL--%>
	var _sendUrl="<%=controller.getStaticPath(request)%>/huifu/send.htm";
	<%--登录URL--%>
	var _loginUrl="<%=controller.getStaticPath(request)%>/login.htm";
	<%--入后台前，校验实名与手机号--%>
	var _escrowCheckUrl = "<%=controller.getStaticPath(request)%>/huifu/openEscrowGuideCheck.htm";
	<%--获取TOKEN的NAME--%>
