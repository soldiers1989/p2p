...
@ResourceAnnotation
public class HFBidRepaymentExecutor extends TenderRepaymentExecutor
{
    
    public HFBidRepaymentExecutor(ResourceProvider resourceProvider)
    {
        ...
        throws Throwable
    {
        ...
        logger.info(String.format("还款订单%s请求参数：%s", orderId, map));
        ...
        try
        {
            ...
            try
            {
                    ...
                    && response.getStatusLine().getStatusCode() == HttpStatus.SC_OK)
                {
                    ...
                    logger.info(String.format("还款订单%s返回参数：%s", orderId, rst));
                }
