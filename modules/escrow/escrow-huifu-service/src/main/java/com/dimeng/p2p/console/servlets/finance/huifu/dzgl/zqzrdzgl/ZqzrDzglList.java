 ...
 */
@Right(id = "P2P_C_FINANCE_HUIFUZQZRLIST", isMenu = true, name = "债权转让记录列表", moduleId = "P2P_C_HUIFU_ZQZRDZGL", order = 0)
public class ZqzrDzglList extends AbstractDzglServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<Order> result = orderManager.search(new ExtOrderQuery()
        {
            ...
            public int getType()
            {
                return OrderType.BID_EXCHANGE.orderType();
            }
