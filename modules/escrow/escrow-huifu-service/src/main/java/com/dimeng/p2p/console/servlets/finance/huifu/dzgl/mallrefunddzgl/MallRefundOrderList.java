 ...
 */
@Right(id = "P2P_C_HUIFUDZGL_SPTKDZGL_LIST", isMenu = true, name = "商品退款对账列表", moduleId = "P2P_C_HUIFUDZGL_SPTKDZGL", order = 1)
public class MallRefundOrderList extends AbstractDzglServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<Order> result = orderManager.search(new ExtOrderQuery()
        {
            ...
            public int getType()
            {
                return OrderType.MALLREFUND.orderType();
            }
