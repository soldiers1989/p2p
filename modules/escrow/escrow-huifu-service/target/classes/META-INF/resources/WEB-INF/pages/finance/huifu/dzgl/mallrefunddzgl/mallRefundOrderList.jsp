...
<%@page import="com.dimeng.p2p.console.servlets.finance.huifu.dzgl.mallrefunddzgl.MallRefundQuery"%>
...
<%
    ...
    CURRENT_SUB_CATEGORY = "SPTKDZ";
    PagingResult<Order> pagingResult = (PagingResult<Order>) request.getAttribute("pagingResult");
%>
<div class="right-container">
    <div class="viewFramework-body">
      	<div class="viewFramework-content">
      		<form action="<%controller.getURI(request, MallRefundOrderList.class);%>" method="post" name="form1" id="searchForm">
				<div class="box box1 mb15">
					<div class="p20">
          				<div class="border">
            				<div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>商品退款对账</div>
            				<div class="content-container pl40 pt30 pr40">
              					<ul class="gray6 input-list-container clearfix">
									...
									<li>
										<span class="display-ib mr5">退款时间：</span>
          				...
          				<table class="table table-style gray6 tl">
							...
							<tr class="dhsbg tc">
								...
								<td>
                                     <%if (dimengSession.isAccessableResource(MallRefundQuery.class)){ %>
...
<script type="text/javascript">
	...
	function goDZ(ordId){
		$.ajax({
			type:"post",
			url: "/console/finance/huifu/dzgl/mallrefunddzgl/mallRefundQuery.htm?ordId=" + escape(ordId),
