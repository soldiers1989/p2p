/*
 * 文 件 名:  HFChargeOrderExecutor.java
 * 版    权:  深圳市迪蒙网络科技有限公司
 * 描    述:  <描述>
 * 修 改 人:  lingyuanjie
 * 修改时间:  2016年8月10日
 ...
 */
@AchieveVersion(version = 20160811)
@ResourceAnnotation
public class HFChargeOrderExecutor extends ChargeOrderExecutor
{
    
    public HFChargeOrderExecutor(ResourceProvider resourceProvider)
    {
    ...
    {
        return HFChargeOrderExecutor.class;
    }
        ...
        throws Throwable
    {
        try
        {
            ...
            {
                // 插入平台账户资金流水
                ptT6101.F06 = ptT6101.F06.add(t6502.F03);
                T6102 cT6102 = new T6102();
                cT6102.F02 = ptT6101.F01;
                cT6102.F03 = FeeCode.CZ;
                cT6102.F04 = ptT6101.F01;
                cT6102.F05 = t;
                cT6102.F06 = t6502.F03;
                cT6102.F08 = ptT6101.F06;
                cT6102.F09 = "平台充值";
                ...
                if (a != null && a.compareTo(BigDecimal.ZERO) > 0)
                {
                    ...
                    {
                        ptT6101.F06 = ptT6101.F06.subtract(cb);
            ...
            // 用户往来账户信息
            T6101 yhT6101 = selectT6101(connection, accountId, T6101_F03.WLZH, true);
            if (yhT6101 == null)
            {
            ...
            // 第三方返回充值手续费
            BigDecimal fee = fee(t6502, a, params);
            
            T6102 uT6102 = new T6102();
            
            {
                // 插入用户资金流水
                yhT6101.F06 = yhT6101.F06.add(t6502.F03);
                uT6102.F02 = yhT6101.F01;
                uT6102.F03 = FeeCode.CZ;
                uT6102.F04 = yhT6101.F01;
                uT6102.F05 = t;
                uT6102.F06 = t6502.F03;
                uT6102.F07 = BigDecimal.ZERO;
                uT6102.F08 = yhT6101.F06;
                uT6102.F09 = "账户充值";
                insertT6102(connection, uT6102);
                
                updateT6101(connection, yhT6101.F06, yhT6101.F01);
            }
            
            //充值手续费由平台出
            if (params != null && params.get("feeCustId").equals(merCustId))
            {
                // 插入平台账户资金流水
                T6102 ptT6102 = new T6102();
                if (fee.compareTo(BigDecimal.ZERO) > 0)
                {
                    ptT6102.F02 = ptT6101.F01;
                    ptT6101.F06 = ptT6101.F06.subtract(fee);
                    ptT6102.F03 = FeeCode.CZ_CB;
                    ptT6102.F04 = yhT6101.F01;
                    ptT6102.F05 = t;
                    ptT6102.F06 = BigDecimal.ZERO;
                    ptT6102.F07 = fee;
                    ptT6102.F08 = ptT6101.F06;
                    ptT6102.F09 = "充值成本";
            ...
            {
                t6502.F03 = t6502.F03.subtract(fee);
                //手续费由用户出
                if (fee.compareTo(BigDecimal.ZERO) > 0)
                {
                    yhT6101.F06 = yhT6101.F06.subtract(fee);
                    uT6102.F02 = yhT6101.F01;
            ...
            {
                expand(connection, t6502, yhT6101, ptT6101);
            }
