...
<div class="top_bar">
    <div class="wrap clearfix">
        ...
        <!--未登录-->
							...
							<%}else{
								...
								T6110_F06 userType = t6110.F06;
							 	int count = serviceSession.getService(com.dimeng.p2p.account.user.service.UserManage.class).getUnReadLetter();
        ...
        <!--<div class="nav fr">
            <ul> 
                <li><a href="#" class="orange_fb">新手指引</a></li>
            ...
            <ul class="clearfix">
                ...
                <li class="user">
                    <a href="<%=configureProvider.format(URLVariable.USER_INDEX) %>" class="name item">
                        <span class="highlight"><%StringHelper.filterHTML(out, serviceSession.getService(UserManage.class).getAccountName());%></span>
                    </a>
                    <div class="child">
                        <div class="arrow"></div>
...
<div class="header">
    <div class="wrap clearfix">
    	<div class="logo fl"><a href="<%configureProvider.format(out,URLVariable.INDEX);%>"><img src="<%="".equals(fileStore.getURL(configureProvider.getProperty(SystemVariable.QTLOGO))) ? controller.getStaticPath(request)+"/images/logo.jpg" : fileStore.getURL(configureProvider.getProperty(SystemVariable.QTLOGO))%>" /></a></div>
    	<div class="main_nav">
        <ul class="clearfix">
  ...
  <%--           <li class="item"><div class="nav"><a href="<%configureProvider.format(out, URLVariable.MALLINDEX_URL);%>">积分商城</a></div></li>
            ...
            <li class="item"><div class="nav"><a href="<%configureProvider.format(out, URLVariable.GYWM_GSJJ);%>">关于我们</a></div></li>           
        </ul>
    </div>       
    </div>
</div>
		...
		<div class="top-center">
			...
			<div class="top-nav clearfix">
				<ul class="clearfix">
					...
					<li>
						<a href="<%configureProvider.format(out,URLVariable.CREDIT_CENTER);%>" class="nav-a">我要借款</a>
						<dl class="subnav">
							<%if (dimengSession == null || !dimengSession.isAuthenticated()) {%>
