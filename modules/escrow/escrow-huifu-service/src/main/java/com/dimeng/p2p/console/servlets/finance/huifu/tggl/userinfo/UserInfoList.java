 ...
 */
@Right(id = "P2P_C_FINANCE_HUIFUUSERINFOLIST", isMenu = true, name = "用户信息列表", moduleId = "P2P_C_HUIFU_USERINFO", order = 0)
public class UserInfoList extends AbstractDzglServlet
{
