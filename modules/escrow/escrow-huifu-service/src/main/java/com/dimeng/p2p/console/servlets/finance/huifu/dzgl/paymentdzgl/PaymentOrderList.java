package com.dimeng.p2p.console.servlets.finance.huifu.dzgl.paymentdzgl;
 ...
 */
@Right(id = "P2P_C_HUIFUDZGL_HKDZGL_LIST", isMenu = true, name = "还款对账列表", moduleId = "P2P_C_HUIFUDZGL_HKDZGL", order = 1)
public class PaymentOrderList extends AbstractDzglServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<Order> result = orderManager.search(new ExtOrderQuery()
        {
            ...
            public int getType()
            {
                return OrderType.BID_REPAYMENT.orderType();
            }
