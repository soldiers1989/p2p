...
<%@page import="com.dimeng.p2p.console.servlets.finance.huifu.dzgl.loandzgl.LoanQuery"%>
...
<div class="right-container">
    <div class="viewFramework-body">
      	<div class="viewFramework-content">
      		<form action="<%controller.getURI(request, LoanOrderList.class);%>" method="post" name="form1" id="searchForm">
				<div class="box box1 mb15">
					<div class="p20">
          				<div class="border">
            				<div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>放款对账</div>
          				...
          				<table class="table table-style gray6 tl">
							...
							<tr class="dhsbg tc">
								...
								<td>
                                     <%if (dimengSession.isAccessableResource(LoanQuery.class)){ %>
...
<script type="text/javascript">
	...
	function goDZ(ordId){
		$.ajax({
			type:"post",
			url: "/console/finance/huifu/dzgl/loandzgl/loanQuery.htm?ordId=" + escape(ordId),
