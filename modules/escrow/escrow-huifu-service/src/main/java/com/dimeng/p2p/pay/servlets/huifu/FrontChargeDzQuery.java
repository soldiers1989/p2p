 ...
 */
public class FrontChargeDzQuery extends AbstractDzglServlet
{
        ...
        throws Throwable
    {
        ...
        final int ordId = IntegerParser.parse(request.getParameter("o"));
        ...
        final T6501 t6501 = bidManage.selectT6501(ordId);
        if (entity == null)
        {
            bidManage.updateOrderStatus(ordId);
        ...
        if (entity != null)
        {
            ...
            {
                out.print("对账失败！原因:" + entity.RespDesc + "！");
                out.flush();
                out.close();
                return;
            }
