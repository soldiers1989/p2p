 ...
 */
@Right(id = "P2P_C_HUIFUDZGL_FKDZGL_LIST", isMenu = true, name = "放款对账列表", moduleId = "P2P_C_HUIFUDZGL_FKDZGL", order = 1)
public class LoanOrderList extends AbstractDzglServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<Order> result = orderManager.search(new ExtOrderQuery()
        {
            ...
            public int getType()
            {
                return OrderType.BID_CONFIRM.orderType();
            }
