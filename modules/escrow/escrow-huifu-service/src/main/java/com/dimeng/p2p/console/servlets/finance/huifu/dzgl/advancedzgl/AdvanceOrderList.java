 ...
 */
@Right(id = "P2P_C_HUIFUDZGL_DFDZGL_LIST", isMenu = true, name = "垫付对账列表", moduleId = "P2P_C_HUIFUDZGL_DFDZGL", order = 1)
public class AdvanceOrderList extends AbstractDzglServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<Order> result = orderManager.search(new ExtOrderQuery()
        {
            ...
            public int getType()
            {
                return OrderType.ADVANCE.orderType();
            }
