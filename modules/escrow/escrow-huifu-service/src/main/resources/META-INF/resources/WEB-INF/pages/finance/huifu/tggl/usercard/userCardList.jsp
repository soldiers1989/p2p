...
<%@page import="com.dimeng.p2p.console.servlets.finance.huifu.tggl.usercard.UserCardInfo"%>
...
<%@page import="com.dimeng.p2p.console.servlets.finance.AbstractFinanceServlet"%>S
...
<div class="right-container">
    <div class="viewFramework-body">
      <div class="viewFramework-content">
                <form action="<%=controller.getURI(request, UserCardList.class)%>" method="post" name="form1" id="form1">
                    <div class="p20">
                        <div class="border">
                            <div class="title-container">
                                <i class="icon-i w30 h30 va-middle title-left-icon"></i>银行卡信息同步
                            </div>
                        ...
                        <div class="border mt20 table-container">
                            <table class="table table-style gray6 tl">
                                ...
                                <tr class="dhsbg">
									...
									<td class="tc">
									<%if (dimengSession.isAccessableResource(UserCardInfo.class)){ %>
										<a target="_self" class="blue ml5" href="<%=controller.getURI(request, UserCardInfo.class) %>?id=<%=item.F01 %>&userTag=<%=item.F06 %>">银行卡信息查询</a>
									<%}else{ %>
                                     	<a class="disabled mr20">银行卡信息查询</a>
                                     <%} %>
									 </td>
								</tr>
                                <%
