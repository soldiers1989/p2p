...
<div class="disclosure_nav">
	<ul>
		<li class="item">
			<a href="javascript:;" class="itemNav"><i class="icon1"></i>关于我们</a>
			<ul id="GYWM_UL">
		...
		<li class="item">
			<a href="javascript:;" class="itemNav"><i class="icon2"></i>信息披露</a>
			<ul id="XXPL_UL">
		...
		<li class="item">
			<a href="javascript:;" class="itemNav"><i class="icon3"></i>安全保障</a>
			<ul id="AQBZ_UL">
