...
<%@page import="com.dimeng.p2p.console.servlets.finance.huifu.dzgl.zqzrdzgl.ZqzrDzglQuery"%>
...
<body>
	<%
		...
		CURRENT_SUB_CATEGORY = "ZQZRDZ";		
		PagingResult<Order> pagingResult = (PagingResult<Order>)request.getAttribute("pagingResult");		
	%>
<div class="right-container">
    <div class="viewFramework-body">
      	<div class="viewFramework-content">
      		<form action="<%controller.getURI(request, ZqzrDzglList.class);%>" method="post" name="form1" id="searchForm">
				<div class="box box1 mb15">
					<div class="p20">
          				<div class="border">
            				<div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i>债权转让对账</div>
            				<div class="content-container pl40 pt30 pr40">
              					<ul class="gray6 input-list-container clearfix">
									...
									<li>
										<span class="display-ib mr5">转让时间：</span>
          				...
          				<table class="table table-style gray6 tl">
							...
							<tr class="dhsbg tc">
								...
								<td class="tc">
                                     <%if (dimengSession.isAccessableResource(ZqzrDzglQuery.class)){ %>
										<a target="_blank" class="blue ml5" onclick="goDZ('/console/finance/huifu/dzgl/zqzrdzgl/zqzrDzglQuery.htm?ordId=<%=order.F01 %>')">去对账</a>
									<%}else{ %>
