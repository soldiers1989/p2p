...
public class BuyBid extends AbstractSecureServlet
{
        ...
        throws Throwable
    {
        ...
        {
            // 获取用户是否已经使用过体验金
            T6103 t6103 = tenderManage.getT6103(loanId, t6110.F01);
            
            // 获取用户是否已经使用过奖励
            T6342 t6342 = tenderManage.getT6342(loanId, t6110.F01);
        ...
        final String source = getAgentType(request);
            ...
            String location =
            getSiteDomain("/pay/service/fuyou/fyouBid.htm?bidId=" + bidId + "&amount=" + amount + "&userReward="
                + userReward + "&myRewardType=" + myRewardType + "&hbRule=" + hbRule + "&jxqRule=" + jxqRule
                + "&source=" + source + "&tranPwd=" + tranPwd);
