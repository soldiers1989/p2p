                    ...
                    <form action="<%=configureProvider.format(URLVariable.PAY_CHARGE)%>" target="_blank" method="post"
                        ...
                        <div class="topup_way">
                            <ul class="cz_li mb30 clearfix">
                                <li>
                                    <label>
                                        <input id="radio1" name="paymentInstitution" type="radio" value="ALLINPAY"
                                               <%if(StringHelper.isEmpty(type) || "ALLINPAY".equals(type)){ %>checked="checked"<%} %>
                                               class="mr10"/>
                                        <img onclick="setCheckBox(1);"
                                             src="<%=controller.getStaticPath(request) %>/images/logo_tl.png"
                                             width="148" height="38" class="border mr20"/>
                                    </label>
                                </li>
                                <li>
                                    <label>
                                        <input id="radio2" name="paymentInstitution" type="radio" value="SHUANGQIAN"
                                               <%if("SHUANGQIAN".equals(type)){ %>checked="checked"<%} %> class="mr10"/>
                                        <img onclick="setCheckBox(2);"
                                             src="<%=controller.getStaticPath(request) %>/images/logo_sq.png"
                                             width="148" height="38" class="border mr20"/>
                                    </label>
                                </li>
                                <li>
                                    <label>
                                        <input id="radio3" name="paymentInstitution" type="radio" value="BAOFU"
                                               <%if("BAOFU".equals(type)){ %>checked="checked"<%} %> class="mr10"/>
                                        <img onclick="setCheckBox(3);"
                                             src="<%=controller.getStaticPath(request) %>/images/logo_bf.png"
                                             width="148" height="38" class="border mr20"/>
                                    </label>
                                </li>
                                <%-- <li>
                                <label>
                                    <input id="radio4" name="paymentInstitution" type="radio" value="HUICHAOGATE" <%if("HUICHAOGATE".equals(type)){ %>checked="checked"<%} %> class="mr10" />
                                    <img onclick="setCheckBox(4);" src="<%=controller.getStaticPath(request) %>/images/logo_hc.png" width="148" height="38" class="border mr20" />
                                </label>
                                </li> --%>
                                <li>
                                    <label>
                                        <input id="radio5" name="paymentInstitution" type="radio" value="LIANLIANGATE"
                                               <%if("LIANLIANGATE".equals(type)){ %>checked="checked"<%} %>
                                               class="mr10"/>
                                        <img onclick="setCheckBox(5);"
                                             src="<%=controller.getStaticPath(request) %>/images/logo_llzf.png"
                                             width="148" height="38" class="border mr20"/>
                                    </label>
                                </li>
                                <%-- 	<li>
                                    <label>
                                        <input id="radio6" name="paymentInstitution" type="radio" value="DINPAY" <%if("DINPAY".equals(type)){ %>checked="checked"<%} %> class="mr10" />
                                        <img onclick="setCheckBox(6);" src="<%=controller.getStaticPath(request) %>/images/logo_zf.png"  width="148" height="38" class="border mr20" />
                                    </label>
                                    </li> --%>
                                <li>
                                    <label>
                                        <input id="radio7" name="paymentInstitution" type="radio" value="CHINABANK"
                                               <%if("CHINABANK".equals(type)){ %>checked="checked"<%} %> class="mr10"/>
                                        <img onclick="setCheckBox(7);"
                                             src="<%=controller.getStaticPath(request) %>/images/logo_wyzx.png"
                                             width="148" height="38" class="border mr20"/>
                                    </label>
                                </li>
                                <li>
                                    <label>
                                        <input id="radio8" name="paymentInstitution" type="radio" value="KJTPAY"
                                               <%if("KJTPAY".equals(type)){ %>checked="checked"<%} %> class="mr10"/>
                                        <img onclick="setCheckBox(8);"
                                             src="<%=controller.getStaticPath(request) %>/images/logo_kjt.png"
                                             width="148" height="38" class="border mr20"/>
                                    </label>
                                </li>
                                <li>
                                    <label>
                                        <input id="radio9" name="paymentInstitution" type="radio" value="HEEPAY"
                                               <%if("HEEPAY".equals(type)){ %>checked="checked"<%} %> class="mr10"/>
                                        <img onclick="setCheckBox(9);"
                                             src="<%=controller.getStaticPath(request) %>/images/logo_hfb.png"
                                             width="148" height="38" class="border mr20"/>
                                    </label>
                                </li>
                                <li>
                                    <label>
                                        <input id="radio10" name="paymentInstitution" type="radio" value="SINAPAY"
                                               <%if("SINAPAY".equals(type)){ %>checked="checked"<%} %> class="mr10"/>
                                        <img onclick="setCheckBox(10);"
                                             src="<%=controller.getStaticPath(request) %>/images/logo_xlzf.png"
                                             width="148" height="38" class="border mr20"/>
                                    </label>
                                </li>
                                <li>
                                    <label>
                                        <input id="radio11" name="paymentInstitution" type="radio" value="GFBPAY"
                                               <%if("GFBPAY".equals(type)){ %>checked="checked"<%} %> class="mr10"/>
                                        <img onclick="setCheckBox(11);"
                                             src="<%=controller.getStaticPath(request) %>/images/logo_gfb.png"
                                             width="148" height="38" class="border mr20"/>
                                    </label>
                                </li>
                                <li>
                                    <label>
                                        <input id="radio12" name="paymentInstitution" type="radio" value="YIFUPAY"
                                               <%if("YIFUPAY".equals(type)){ %>checked="checked"<%} %> class="mr10"/>
                                        <img onclick="setCheckBox(12);"
                                             src="<%=controller.getStaticPath(request) %>/images/logo_yb.png"
                                             width="148" height="38" class="border mr20"/>
                                    </label>
                                </li>
                                <div class="clear"></div>
