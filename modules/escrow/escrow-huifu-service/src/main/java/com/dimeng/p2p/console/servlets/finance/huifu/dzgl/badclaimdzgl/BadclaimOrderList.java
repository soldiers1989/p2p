 ...
 */
@Right(id = "P2P_C_HUIFUDZGL_BLZQGMDZGL_LIST", isMenu = true, name = "不良债权购买对账列表", moduleId = "P2P_C_HUIFUDZGL_BLZQGMDZGL", order = 1)
public class BadclaimOrderList extends AbstractDzglServlet
{
        ...
        throws Throwable
    {
        ...
        PagingResult<Order> result = orderManager.search(new ExtOrderQuery()
        {
            ...
            public int getType()
            {
                return OrderType.BUY_BAD_CLAIM.orderType();
            }
